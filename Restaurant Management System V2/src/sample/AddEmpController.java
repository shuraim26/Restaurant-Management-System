...
public class AddEmpController {
    ...
    public AddEmpController() throws SQLException {
    }
    ...
    public void add(ActionEvent actionEvent) throws SQLException {
        ...
        else if(pass.getText()!=repass.getText())
        {
            ...
            String check = "select * from users where username='" + uname.getText() + "'";
            ...
            if (rs.next()) {
                ...
                String sql="insert into users values('"+uname.getText()+"','"+pass.getText()+"'";
